    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-16 px-6 sm:px-8 font-sans selection:bg-blue-100 selection:text-blue-900">
      <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-xl border border-gray-100 transform transition-all">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight mt-2">Create your account</h2>
          <p className="text-gray-500 font-medium mt-3">Select your objective to begin.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSignUp}>
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-extrabold tracking-widest uppercase text-gray-500 mb-2">Full Name</label>
              <input
                type="text"
          ...
          >
            {loading ? 'Creating account...' : `Sign Up as ${role === 'student' ? 'Student' : 'Creator'}`}
          </button>
        </form>
        
        <p className="text-center mt-10 text-gray-500 font-medium text-sm">
          Already have an account?{' '}
          <Link href="/login" className="text-blue-600 hover:text-blue-800 font-extrabold transition-colors">
            Log in
          </Link>
        </p>
      </div>
